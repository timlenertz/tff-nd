#ifndef TFF_NDARRAY_TIMED_OPAQUE_VIEW_CAST_H_
#define TFF_NDARRAY_TIMED_OPAQUE_VIEW_CAST_H_

#include "../config.h"
#if TFF_ND_WITH_OPAQUE && TFF_ND_WITH_TIMED

#include "ndarray_timed_opaque_view.h"
#include "ndarray_opaque_view_cast.h"
...
auto to_opaque(const ndarray_timed_view<Concrete_dim, Concrete_elem>& concrete_view, const Opaque_frame_format& frm) {
...
auto from_opaque(const ndarray_timed_opaque_view<Opaque_dim, Opaque_mutable, Opaque_frame_format>& opaque_view) {
